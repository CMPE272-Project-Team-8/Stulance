...
<head>
    ...
    <link href="<%=request.getContextPath()%>/forwards/css/shop-homepage.css" rel="stylesheet">
     <link href="<%=request.getContextPath()%>http://stulance.mybluemix.net/css/freelancer.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <%if(request.getSession().getAttribute("login").equals("true")) { %>
                     <li>
                        <a href="<%=request.getContextPath() %>/myStulance/all">My Stulance</a>
                    </li>
                    <li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
				...
				<div class="list-group">
                	<h5><a href = "<%=request.getContextPath()%>/get/jobs/?category=household&field=all">Houshold Work</a></h5>
                	<ul>
